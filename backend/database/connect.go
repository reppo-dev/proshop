...
func Connect() {
	...
	db.AutoMigrate(&models.User{},&models.Product{},&models.Cart{},&models.CartItem{},&models.Category{},&models.Address{},&models.OrderItem{},&models.Order{},&models.OrderAddress{})
}